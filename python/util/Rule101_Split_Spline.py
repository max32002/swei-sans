    ...
    def apply(self, spline_dict, resume_idx):
        ...
        if nodes_length >= rule_need_lines:
            for idx in range(nodes_length):
                ...
                #print(idx,": debug Rule#101:",format_dict_array[idx]['code'])
                ...
                for idx_j in range(nodes_length-1):
                    ...
                    if compare_distance <= TOO_CLOSE_DISTANCE:
                        #print(idx,": match too close Rule#101:",format_dict_array[idx]['code'])
                ...
                if False:
                    ...
                    for debug_idx in range(6):
                        print(debug_idx-2,": values for Rule#101:",format_dict_array[(idx+debug_idx+nodes_length-2)%nodes_length]['code'])


                if is_match_pattern:
                    #print("match rule Split Spline!")
                    #print(idx,": debug Rule#101:",format_dict_array[idx]['code'])
