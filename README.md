...
@font-face {
  ...
  src: url(https://github.com/max32002/swei-sans/raw/master/WebFont/CJK%20TC/SweiSansCJKtc-Regular.woff2) format("woff2")
  , url(https://github.com/max32002/swei-sans/raw/master/WebFont/CJK%20TC/SweiSansCJKtc-Regular.woff) format("woff");
}
```
